 ...
 * sight-line cross and a copper core (the one warm signature in the system); the wordmark pairs the display face with a
 * small "IQ" chip.
 */
  ...
  return (
    <span className={cn('inline-flex items-center gap-2.5', className)}>
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none" aria-hidden className="shrink-0">
        ...
        <circle cx="11" cy="11" r="2.6" fill="#c2673a" />
        <circle cx="11" cy="11" r="1.1" fill="#1d1f21" />
      </svg>
      {showWord && (
        <span className="flex items-baseline gap-1.5">
          ...
          <span className="rounded-[4px] bg-fg px-1 py-[2px] font-mono text-[8.5px] font-semibold leading-none tracking-[0.08em] text-bg">
            IQ
          </span>
        </span>
      )}
